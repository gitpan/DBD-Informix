...
#
#	Technical Support Tools for IBM Informix Database Driver for Perl DBI Version 2007.0904 (2007-09-04)
#
...
We normally only support IBM Informix Database Driver for Perl DBI Version 2007.0904 (2007-09-04)
...
Client SDK Version 2.70 (ESQL/C 9.51) or later

=back

You may use Perl Version 5.6.1, but you should ideally be using Perl
Version 5.8.0 or a later, stable version of Perl (for example, Version
5.8.6).
...
IBM Informix Database Driver for Perl DBI Version 2007.0904 (2007-09-04) is believed to work with all versions of ESQL/C and ClientSDK
...
5.005_03 upwards (subject to using an appropriate version of DBI), but
you should aim to use 5.8.x until there is a later stable version (such
as 5.10) available.
...
to get IBM Informix Database Driver for Perl DBI Version 2007.0904 (2007-09-04) working.
